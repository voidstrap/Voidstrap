...
namespace Hellstrap.UI.ViewModels.Settings
{
    public class FastFlagsViewModel : NotifyPropertyChangedViewModel
    {
        ...
        public bool Unified
        {
            get => App.FastFlags.GetPreset("Unified.Lighting") == "True"; // we use this fflag to determine if preset is enabled
            set
            {

                App.FastFlags.SetPreset("Unified.Lighting", value ? "True" : null);
            }
        }

        public bool LowMemory
        {
            get => App.FastFlags.GetPreset("LowMemory.LowMem") == "True"; // we use this fflag to determine if preset is enabled
            set
            {

                App.FastFlags.SetPreset("LowMemory.LowMem", value ? "True" : null);
            }
        }
