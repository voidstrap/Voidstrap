...
{
    {
        Enums.CursorType.StoofsCursor, new Dictionary<string, string>()
        {
    ...
    {
        Enums.CursorType.From2006, new Dictionary<string, string>()
        {
    ...
    {
        Enums.CursorType.From2013, new Dictionary<string, string>()
        {
