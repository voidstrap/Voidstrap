...
namespace Hellstrap
{
    ...
    { "Telemetry.VoiceChatDetailedErrors", "DFFlagVoiceChatV2DetailedPublishingErrorTelemetry" },
    { "Telemetry.TextChatAsyncFailureThrottle", "DFFlagTextChatTelemetrySendAsyncFailureThrottlePermyriad" },
