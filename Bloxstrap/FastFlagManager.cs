...
namespace Hellstrap
{
    ...
    { "Telemetry.SoundTelemetry", "FFlagDisableSoundTelemetry" },
        ...
        public override void Load(bool alertFailure = true)
        {
            ...
            if (GetPreset("Decomposition.Log") != "True")
                SetPreset("Decomposition.Log", "True");

            if (GetPreset("Perf.Log") != "True")
                SetPreset("Perf.Log", "True");

            if (GetPreset("Rendering.ManualFullscreen") != "True") //dx and vulken lol alt enter fix
